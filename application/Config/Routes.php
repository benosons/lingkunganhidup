...
$routes->add('regulasi', 'View::regulasi');
$routes->add('info_perizinan', 'View::info_perizinan');
$routes->add('prosedur_perizinan', 'View::prosedur_perizinan');
$routes->add('contact', 'View::contact');
$routes->add('login_perizinan', 'View::login_perizinan');
$routes->add('registrasi_perizinan', 'View::registrasi_perizinan');
$routes->add('kegiatanUser', 'View::kegiatanUser');
$routes->add('laporan_rth', 'View::laporan_rth');
$routes->add('laporan_ozon', 'View::laporan_ozon');
